...
export const columnCharthome2 = {
  series: [
    {
      name: "Revenue",
      data: [30, 100, 40, 70, 45, 100, 75, 40, 80, 90],
    },
  ],
  chartOptions: {
    chart: {
...
export const pieChart = {
  series: [648935, 224384, 152483, 98432, 87243, 54981, 87593],

  chartOptions: {
    labels: ["肖副總", "簡助理", "妤美人", "金秘書", "排宿錠", "小鰻力", "生命之泉"],
    dataLabels: {
      enabled: true,
    },

    colors: [colors.success, colors.warning, colors.purple, colors.info, colors.gray, colors.primary, colors.danger],
    legend: {
      position: "bottom",
      fontSize: "12px",
      fontFamily: "Inter",
...
export const pieChartTwo = {
  series: [48935, 24384, 52483, 8432, 7243, 54981, 53543],

  chartOptions: {
    labels: ["潔顏慕斯", "保濕精華", "靚顏精華", "抗皺精華", "亮顏乳霜", "煥顏乳霜", "晚安活化霜"],
    dataLabels: {
      enabled: true,
    },
...
export const pieChartDarkTwo = {
  series: [48935, 24384, 52483, 8432, 7243, 54981, 87593],
