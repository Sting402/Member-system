      ...
      <div class="-mx-6">
        ...
        compactMode>
          ...
          <!-- <span v-if="props.column.field == 'role'" class="block w-full">
            ...
            <span v-if="props.column.field == 'price1'">
              {{ "$" + props.row.price1 }}
            </span>
            <span v-if="props.column.field == 'price2'">
              {{ "$" + props.row.price2 }}
            </span>
...
import { agentPriceTable } from "../../../constant/demo-data";
export default {
  components: {
    Pagination,
    Icon,
